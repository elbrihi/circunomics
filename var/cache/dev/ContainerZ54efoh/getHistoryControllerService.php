...
class getHistoryControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.B_fynoQ'] ?? $container->load('get_ServiceLocator_BFynoQService'))->withContext('App\\Controller\\HistoryController', $container));
